...
document.querySelector(".pokeheight").innerHTML = `<p>Height: ${data.height}</p>`;
    
document.querySelector(".pokeweight").innerHTML = `<p>Weight: ${data.weight}</p>`;
    
document.querySelector(".poketype").innerHTML = `<p>Type: ${data.types[0].type.name}</p>`;
document.querySelector(".pokeability").innerHTML = `<p>Ability: ${data.abilities[0].ability.name}</p>`;
    // document.querySelector(".poketype2").innerHTML = `<p>Type: ${data.types[1].type.name}</p>`;
   });
}
